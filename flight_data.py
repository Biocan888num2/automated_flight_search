...
class FlightData:
    ...
    def __init__(self, price, origin_airport, destination_airport, out_date, return_date, stops):
        ...
        - stops: number of stops between departure and arrival.
        """
        self.price = price
...
def find_cheapest_flight(data):
    ...
    Returns:
        ...
        or a FlightData instance where all fields are 'NA' if no valid flight data is available
            ...
            >>> This function initially checks if the data contains valid flight entries 
            >>> If no valid data is found it returns a FlightData object containing "N/A" for all fields
            >>> Otherwise, it starts by assuming the first flight in the list is the cheapest 
            >>> It then iterates through all available flights in the data,
            >>> updating the cheapest flight details whenever a lower-priced flight is encountered
            >>> The result is a populated FlightData object with the details of the most affordable flight
    """
    ...
    canadian_price = 1.8 * float(first_flight["price"]["grandTotal"])
    lowest_price = round(canadian_price, 2)
    ...
    for flight in data["data"]:
        ...
        if price < lowest_price:
            cnd_price = 1.8 * price
            lowest_price = round(cnd_price, 2)
            ...
            print(f"Lowest price to {destination} is ${lowest_price} CAD")
